...
Public Class Main_Screen
    ...
    Private Sub PreCount_Function(ByVal worker As BackgroundWorker)
        Try
            ...
            Dim backupfolder As String = (dinfo.FullName & "\").Replace("\\", "\") & "TMS Backup " & Format(Now, "yyyyMMddHHmmss")
                ...
                If dinfo.Parent.Exists Then
                    ...
                    For Each finfo As FileInfo In dinfo.GetFiles()
                        ...
                        Try
                            ...
                            Dim savename As String = savedirectory & Format(Now(), "yyyyMMddHHmmss") & "_" & finfo.Name
                            Try
